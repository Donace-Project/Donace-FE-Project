...
export default function ExploreHome() {
    return (
        <div id="page-content" className="pt-[calc(3.25rem+1px)] box-border">
            <div id="page-header" className="opacity-1 pt-[3rem] container box-border">
            ...
            <div className="">
                <h1 className="container text-[1.75rem] font-[400] leading-[1.2] text-gray-700">Tech Events in Your City</h1>
                ...
                <div className="container grid grid-cols-12 gap-5 mt-20">
                    <Link href={"/"} className="col-span-12 md:col-span-3 rounded">
                    ...
                    <div className="col-span-12 md:col-span-3 rounded">
                        <AspectRatio ratio={4 / 3} className="bg-muted ">
                            <Image
                                src="https://picsum.photos/1000/1000?random=1"
                                alt="Photo by Drew Beamer"
