                ...
                <div id="zm-container" className="pt-[.25rem!important] max-w-[820px] m-[0_auto]">
                    <div id="page-header-tabs-wrapper" className="flex justify-between items-baseline">
                        <div id="tabs" className="flex max-w-[100%] overflow-auto min-w-[0] gap-[1rem] flex-[1_1]">
                            ...
                            <Link href={"/my-calendar-newletters"} id="tab" className="text-[#fff] border-b-2 border-solid border-b-gray-200 whitespace-nowrap inline-block pb-[0.5rem] cursor-pointer no-underline">
                                Newletters
                            </Link>
                ...
                <div id="can-divide with-divider medium">
                    <div id="section-title-wrapper medium">
                        <div id="section-title-row" className="mb-5 flex justify-between items-center">
                            <h2 className="text-[1.25rem] font-semibold text-[#fff] mb-0 leading-[1.2] mt-0">Drafts</h2>
                    ...
                    <div id="section-title-wrapper">
                        <div id="section-subtitle" className="mt-[-.875rem] text-[#d2d4d7] text-base mb-[1.5rem!important]">As you write, your drafts will be automatically saved and appear here.</div>
                    </div>
                </div>
                <div id="can-divide with-divider medium" className="mt-8 pt-8 border-t border-solid border-[rgba(255,255,255,0.08)]">
                    <div id="section-title-wrapper medium">
                        <div id="section-title-row" className="mb-5 flex justify-between items-center">
                            <h2 className="text-[1.25rem] font-semibold text-[#fff] mb-0 leading-[1.2] mt-0">Published</h2>
                    ...
                    <div id="lux-empty-state" className="text-center mt-8 flex flex-col items-center">
                        <div id="icon illu" className="justify-center flex items-center">
                            <div className="mb-0">
                                <Mailbox className="w-[250px] h-auto block align-middle text-[#fff]"/>
                            </div>
                        </div>
                        <h3 className="text-[hsla(0,0%,100%,.79)] p-[0!important] mt-[0.25rem!important] mb-[0!important] text-[1.125rem] leading-[1.2] font-semibold">No Newsletters</h3>
                        <div className="pl-12 pr-12 text-[hsla(0,0%,100%,.5)] mt-[.5rem!important]">Tell your subscribers about events and what is happening.</div>
                    </div>
