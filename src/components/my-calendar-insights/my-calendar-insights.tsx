                ...
                <div id="zm-container" className="pt-[.25rem!important] max-w-[820px] m-[0_auto]">
                    <div id="page-header-tabs-wrapper" className="flex justify-between items-baseline">
                        <div id="tabs" className="flex max-w-[100%] overflow-auto min-w-[0] gap-[1rem] flex-[1_1]">
                            ...
                            <Link href={"/my-calendar-insights"} id="tab" className="border-b-2 border-solid border-[rgb(19,21,23)] whitespace-nowrap inline-block pb-[0.5rem] cursor-pointer no-underline">
                                Insights
                            </Link>
                ...
                <div id="can-divide with-divider medium">
                    <div id="section-title-wrapper medium">
                        <div id="section-title-row" className="mb-5 flex justify-between items-center">
                            <h2 className="text-[1.25rem] font-semibold mb-0 leading-[1.2] mt-0">Event Feedback</h2>
                                    ...
                                    <div id="lux-menu-trigger-wrapper" className="cursor-pointer inline-flex min-w-0">
                                        <Button variant="nothing" type="button" className="text-[rgba(19,21,23,0.64)] bg-[rgba(19,21,23,0.04)] border-transparent border border-solid cursor-pointer font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-none max-w-full text-[0.875rem] p-[0.4375rem_0.625rem] h-[calc(1.75rem+2*1px)] w-fit flex items-center m-0 leading-[1.5]">
                                            ...
                                            <span className="ml-1 mr-[-0.125rem] flex items-center">
                                                <ChevronDown className="mr-0 stroke-[2.5] w-[0.875rem] h-[0.875rem] flex-shrink-0 block align-middle text-black " />
                                            </span>
                                        </Button>
                                    </div>
                                    <Button variant="nothing" type="button" className="text-[rgba(19,21,23,0.64)] bg-[rgba(19,21,23,0.04)] border-transparent border border-solid cursor-pointer font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-none max-w-full text-[0.875rem] p-[0.4375rem_0.625rem] h-[calc(1.75rem+2*1px)] w-fit flex items-center m-0 leading-[1.5]">
                    ...
                    <div id="lux-empty-state" className="text-center mt-8 pb-[.5rem!important] flex flex-col items-center">
                        <div id="icon illu" className="justify-center flex items-center">
                            <div className="mb-[20px]">
                                <CalendarRange className="w-[250px] h-auto block align-middle" />
                            </div>
                        </div>
                        <h3 className="text-[rgba(19,21,23,0.64)] p-[0!important] mt-[1.5rem!important] mb-[0!important] text-[1.125rem] leading-[1.2] font-semibold">No Feedback</h3>
                        <div className="pl-12 pr-12 text-[rgba(19,21,23,0.36)] mt-[.5rem!important]">No feedback has been collected for your events.</div>
                    </div>
                </div>
                <div id="can-divide with-divider medium" className="mt-8 pt-8 border-t border-solid border-[rgba(19,21,23,0.08)]">
                    <div id="section-title-wrapper medium">
                        <div id="section-title-row" className="mb-5 flex justify-between items-center">
                            <h2 className="text-[1.25rem] font-semibold mb-0 leading-[1.2] mt-0">Sales History</h2>
                            <div id="right-element" className="m-[-.25rem_0]">
                                <div className="gap-[.25rem] flex items-center">
                                    <div id="lux-menu-trigger-wrapper" className="cursor-pointer inline-flex min-w-0">
                                        <Button variant="nothing" type="button" className="text-[rgba(19,21,23,0.64)] bg-[rgba(19,21,23,0.04)] border-transparent border border-solid cursor-pointer font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-none max-w-full text-[0.875rem] p-[0.4375rem_0.625rem] h-[calc(1.75rem+2*1px)] w-fit flex items-center m-0 leading-[1.5]">
                                            <Download className="text-[rgba(19,21,23,0.64)] mr-[0.375rem] stroke-[2.5] w-[0.875rem] h-[0.875rem] block align-middle" />
                                            <div id="label" className="text-[rgba(19,21,23,0.64)] leading-[1] m-[-4px_0] p-[4px_0] overflow-hidden text-ellipsis">Download CSV</div>
                                        </Button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="lux-empty-state" className="text-center mt-8 flex flex-col items-center">
                        <div id="icon illu" className="justify-center flex items-center">
                            <div className="mb-[20px]">
                                <Receipt fill="none" className="w-[250px] h-auto block align-middle" />
                            </div>
                        </div>
                        <h3 className="text-[rgba(19,21,23,0.64)] p-[0!important] mt-[1.5rem!important] mb-[0!important] text-[1.125rem] leading-[1.2] font-semibold">No Transactions</h3>
                        <div className="pl-12 pr-12 text-[rgba(19,21,23,0.36)] mt-[.5rem!important]">You have not made any sales.</div>
                    </div>
                </div>
            </div>
        </div>
