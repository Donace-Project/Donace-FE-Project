...
import { ArrowDown, ArrowUpToLine, CheckCircle2, ChevronsUpDown, Copy, FileImage, Globe, GlobeIcon, ImageIcon, Info, MapPin, Pen, PlusIcon, Sparkles, Ticket, UserCheck2, Video, Wallet } from "lucide-react";
                        ...
                        <div id="page-container" className="min-h-[auto] relative bg-transparent">
                            <div id="zm-container" className="p-[1.5rem_1rem] max-w-[820px] m-[0_auto]">
                                <div id="outer-wrapper" className="m-[0px_-1.25rem] py-4 px-[1.25rem] p-[1rem_1.25rem]">
                                    <div id="content-card" className="p-[1rem_1.25rem] relative rounded-[0.75rem] bg-[#fff] border border-solid border-[#fff] backdrop-filter-none shadow-none overflow-hidden">
                                        <div id="content-container" className="grid grid-cols-[1fr_1fr] gap-[2.5rem]">
                                            <div id="left" className="min-w-0">
                                                <div>
                                                    <Popover>
                                                        <PopoverTrigger asChild>
                                                            <div id="lux-menu-trigger" className="hover:bg-[rgba(19,21,23,0.1)] m-[-0.375rem_-0.625rem] p-[0.375rem_0.625rem] cursor-pointer rounded-[0.5rem] gap-[0.75rem] w-[240px] inline-flex min-w-0 leading-[1.3] items-center transition-all duration-300 ease-in-out">
                                                ...
                                                <div id="name-input-wrapper" className="h-[42px] m-[1.5rem_0px] flex">
                                                    <textarea className="h-[42px!important] leading-[1.3] overflow-hidden border-none bg-transparent p-0 text-[2rem] font-semibold w-full resize-none m-0 outline-none" spellCheck="false" autoCapitalize="words" placeholder="Event Name" />
                                                </div>
                                                <div className="">
                                                    <div id="attribute-row" className="w-full gap-[0.75rem] mb-4 flex items-start">
                                                        <div id="icon-container" className="w-[2.5rem] h-[2.5rem] border border-solid border-[rgba(19,21,23,0.08)] text-[rgba(19,21,23,0.36)] rounded-[0.5rem] flex-shrink-0 mt-[0.5rem] overflow-hidden justify-center flex items-center">
                                                            <div id="full-width" className="text-center w-full">
                                                                <div id="month" className="bg-[rgba(19,21,23,0.08)] text-[0.5rem] font-semibold uppercase p-[2px]">Sep</div>
                                                                <div id="day" className="transform translate-y-[1px] font-medium">29</div>
                                                            </div>
                                                        </div>
                                                        <div id="time-picker" className="bg-[rgba(19,21,23,0.04)] rounded-[0.5rem] overflow-hidden flex-1">
                                                                ...
                                                                <div className="">
                                                                    <div id="datetime-timezone" className="w-auto max-w-full">
                                                                        <div id="datetime-input" className="max-w-[13.5rem] flex items-stretch">
                                                                            <div id="date-input" className="border-r-[0] rounded-[0.25rem] border border-solid border-transparent bg-[rgba(19,21,23,0.04)] flex-1 flex items-center">
                                                                                    ...
                                                                                    <Popover>
                                                                                        <PopoverTrigger asChild>
                                                                                            <Button
                                                                                                variant={"ghost"}
                                                                                                className={cn(
                                                                                                    "w-auto justify-between text-[rgb(19,21,23)] font-medium bg-[rgba(19,21,23,0.04)]",
                                                                                                    !date1 && "text-[rgb(19,21,23)]"
                                                                                                )}
                                                                                            >
                                                            ...
                                                            <div id="tz-input" className="p-[0.25rem_0.75rem] transition-all duration-300 ease-in-out">
                                                                <div id="lux-menu-trigger-wrapper" className="cursor-pointer inline-flex min-w-0 w-full">
                                                                    <div className="text-[0.8125rem] text-[rgba(19,21,23,0.64)] gap-[.25rem] flex items-center">
                                                            ...
                                                            <Dialog>
                                                                <DialogTrigger asChild>
                                                                    <Button variant="nothing" type="button" className="hover:bg-[rgba(19,21,23,0.1)] border-t-none border-solid border-t-[rgba(19,21,23,0.08)] w-full box-border cursor-pointer transition-all duration-300 ease-in-out text-[0.8125rem] text-[rgba(19,21,23,0.64)] gap-[.5rem] flex items-center m-0 bg-transparent leading-[1.5] justify-start rounded-t-none border">
                                                                        <div id="icon">
                                                                ...
                                                                <DialogContent className="opacity-[1] max-w-[400px] overflow-hidden flex flex-col max-h-[70vh] rounded-[1rem] shadow-lg bg-[#fffd] backdrop-blur-lg">
                                                                    <div id="lux-modal-body" className="w-full p-4 overflow-auto">
                                                                        <DialogHeader>
                                                                            <DialogTitle className="text-[1.125rem] leading-[1.2] font-semibold mt-0 mb-4">
                                                                                Create Multi-Session Event
                                                                            </DialogTitle>
                                                                        </DialogHeader>
                                                                        <div id="input-wrapper" className="pb-[1rem!important]">
                                                                            ...
                                                                            <div id="duration-input" className="flex max-w-[350px]">
                                                                                <div id="lux-input-wrapper" className="max-w-[auto] mr-[.5rem!important]">
                                                                                        ...
                                                                                        <div id="input-wrapper" className="flex items-baseline">
                                                                                            <div className="flex-1 flex items-center">
                                                                                                ...
                                                                                                <div id="input-inner-wrapper" className="relative flex-1">
                                                                                                    <Input placeholder="1" type="number" inputMode="numeric" className="min-w-[5rem] text-right text-base h-[calc(2.25rem+2*1px)] p-[0.625rem_0.875rem] rounded-r-[0!important] m-0 border border-solid border-[#333537] outline-none " />
                                                                                                    <div id="indicator invisible" className="pointer-events-none opacity-0 absolute right-[.75rem] bottom-[50%]"></div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div id="accessory-text" className="text-[1rem] h-[calc(2.25rem+2*1px)] p-[0.625rem_0.875rem] border-l-0 rounded-l-[0!important] leading-[1] text-[rgba(19,21,23,0.64)] bg-[rgba(19,21,23,0.04)] border border-solid border-[#ebeced] rounded-[0.5rem] flex items-center">hour</div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div id="inner-wrapper" className="inline-block w-full">
                                                                                        <div className="flex items-baseline">
                                                                                            <div className="flex-1 flex items-center">
                                                                                                <div id="zero-with-filler">&nbsp;</div>
                                                                                                <div id="input-inner-wrapper" className="relative flex-1">
                                                                                                    <Input placeholder="0" type="number" inputMode="numeric" className="min-w-[5rem] text-right text-base h-[calc(2.25rem+2*1px)] p-[0.625rem_0.875rem] rounded-r-[0!important] m-0 border border-solid border-[#333537] outline-none " />
                                                                                                    <div id="indicator invisible" className="pointer-events-none opacity-0 absolute right-[.75rem] bottom-[50%]"></div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div id="accessory-text" className="text-[1rem] h-[calc(2.25rem+2*1px)] p-[0.625rem_0.875rem] border-l-0 rounded-l-[0!important] leading-[1] text-[rgba(19,21,23,0.64)] bg-[rgba(19,21,23,0.04)] border border-solid border-[#ebeced] rounded-[0.5rem] flex items-center">minute</div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div id="helper-text" className="text-[#939597] max-h-0 overflow-hidden opacity-0 transition-all duration-300 ease-in-out text-[0.875rem]"></div>
                                                                                </div>
                                                    ...
                                                    <div id="attribute-row" className="w-full gap-3 mb-4 flex items-start">
                                                        <div id="icon" className="w-10 h-10 border border-solid border-[rgba(19,21,23,0.08)] text-[rgba(19,21,23,0.36)] rounded-[0.5rem] flex-shrink-0 mt-2 overflow-hidden justify-center flex items-center">
                                                            ...
                                                            <PopoverTrigger asChild className="w-full">
                                                                <div id="location-picker-wrapper" className="min-w-0 flex-1">
                                                                    <div id="lux-menu-trigger" className="cursor-pointer inline-flex min-w-0 w-full ">
                                                                        <div id="meta-row" className="hover:bg-[rgba(19,21,23,0.1)] relative bg-[rgba(19,21,23,0.04)] rounded-[0.5rem] min-w-0 transition-all duration-300 ease-in-out w-full">
                                                                            <div id="inner" className="min-h-[3.5625rem] p-[0.375rem_0.75rem] rounded-[0.5rem]">
                                                                                <div id="">
                                                                                    <div id="">
                                                                                        <div id="" className="min-w-0">
                                                                                            <div id="title" className="text-[rgba(19,21,23,0.64)] font-medium overflow-hidden text-ellipsis whitespace-nowrap">Add Event Location</div>
                                                                                            <div id="subtitle" className="overflow-hidden text-ellipsis whitespace-nowrap text-[0.875rem] text-[rgba(19,21,23,0.64)]">Offline location or virtual link</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div id="advanced-options" className="mt-[1.5rem!important]">
                                                    <Label id="lux-input-label" className="text-[0.875rem] block mb-[.375rem] font-medium text-[rgba(19,21,23,0.64)] transition-all duration-300 ease-in-out">
                                                        <div>Event Options</div>
                                                    </Label>
                                                    <div id="options-card" className="mt-2 rounded-[0.5rem] overflow-hidden">
                                                        <div id="option-button" className="w-full p-[0.5rem_0.75rem] transition-all duration-300 ease-in-out relative overflow-hidden bg-[rgba(19,21,23,0.04)]">
                                                            <div id="divider"></div>
                                                            <div id="" className="gap-[.5rem] flex items-center">
                                                                <div id="icon" className="mr-1 text-[rgba(19,21,23,0.2)]">
                                                                    <Ticket className="block w-4 h-4 align-middle" />
                                                                </div>
                                                                <div id="label" className="select-none flex-1 text-[rgba(19,21,23,0.64)]">Tickets</div>
                                                                <div className="gap-[.25rem] flex items-center">
                                                                    <div id="value" className="font-medium text-[rgba(19,21,23,0.64)]">Free</div>
                                                                    <Dialog>
                                                                        <HoverCard>
                                                                            <HoverCardTrigger asChild>
                                                                                <DialogTrigger asChild>
                                                                                    <Button variant="nothing" className="mr-[-0.25rem] text-[rgba(19,21,23,0.2)] p-[0.3125rem] h-auto border-[transparent!important] border border-solid bg-transparent gap-[0.375rem] flex-shrink-0 cursor-pointer transition-[all_0.3s_cubic-bezier(0.4,0,0.2,1)] font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-2 outline outline-transparent max-w-full text-[0.875rem] w-fit hover:bg-gray-400 hover:text-white">
                                                                        ...
                                                                        <DialogContent className="opacity-[1] w-full p-[1rem_1.25rem] overflow-hidden rounded-[1rem] shadow-lg bg-[#fffd] backdrop-blur-lg">
                                                                            <div id="alert-wrapper" className="p-1">
                                                                                <DialogHeader className="pt-1">
                                                                                    <div id="lux-alert-top" className="pt-1">
                                                                                        <div id="icon-wrapper" className="m-[0.25rem_0px_0.75rem] w-14 h-14 rounded-[1000px] text-[#737577] bg-[rgba(19,21,23,0.04)] justify-center flex items-center">
                                                                                ...
                                                                                <DialogTitle className="pt-2 items-center">
                                                                                    <div className="mt-4 flex items-center">
                                                                                        <Button variant="nothing" type="button" className="flex-1 text-[rgb(19,21,23)] bg-[#333537] border-gray-200 border border-solid w-full cursor-pointer transition-[all_0.3s_cubic-bezier(0.4,0,0.2,1)] font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-2 outline outline-transparent max-w-full p-[0.625rem_0.875rem] h-[calc(2.25rem+2*1px)] flex items-center m-0 leading-[1.5]">
                                                                                            <div id="label" className="text-[#fff] font-medium">Connect VNPay</div>
                                                                                        </Button>
                                                                                    </div>
                                                                                </DialogTitle>
                                                                            </div>
                                                        ...
                                                        <div id="option-button" className="w-full p-[0.5rem_0.75rem] transition-all duration-300 ease-in-out relative overflow-hidden bg-[rgba(19,21,23,0.04)]">
                                                            <div id="divider" className="absolute top-0 left-10 right-0 border-b border-solid border-[rgba(19,21,23,0.04)] z-10"></div>
                                                            <div id="" className="gap-[.5rem] flex items-center">
                                                                <div id="icon" className="mr-1 transition-all duration-300 ease-in-out text-[rgba(19,21,23,0.2)]">
                                                                    <UserCheck2 className="block w-4 h-4 align-middle" />
                                                                </div>
                                                                <Label id="label" className="select-none cursor-pointer transition-all duration-300 ease-in-out flex-1 text-[rgba(19,21,23,0.64)]">Require Approval</Label>
                                                        ...
                                                        <div id="option-button" className="w-full p-[0.5rem_0.75rem] transition-all duration-300 ease-in-out relative overflow-hidden bg-[rgba(19,21,23,0.04)]">
                                                            ...
                                                            <div id="" className="gap-[.5rem] flex items-center">
                                                                ...
                                                                <div id="label" className="select-none flex-1 text-[rgba(19,21,23,0.64)]">Capacity</div>
                                                                <div className="gap-[.25rem] flex items-center">
                                                                    <div id="value" className="font-medium text-[rgba(19,21,23,0.64)]">Unlimited</div>
                                                                    <Dialog>
                                                                        <HoverCard>
                                                                            <HoverCardTrigger asChild>
                                                                                <DialogTrigger asChild>
                                                                            ...
                                                                            <div id="alert-wrapper" className="p-1">
                                                                                <DialogHeader className="pt-1">
                                                                                    <div id="lux-alert-top" className="pt-1">
                                                                                        ...
                                                                                        <DialogDescription>
                                                                                            <div id="desc" className="text-[rgba(19,21,23,0.64)]">
                                                                                ...
                                                                                <DialogTitle>
                                                                                    <form action={"#"} className="gap-4 pt-[.25rem!important] mt-[.5rem!important] flex flex-col">
                                                                                            ...
                                                                                            <div id="inner-wrapper" className="inline-block w-full">
                                                                                                ...
                                                                                                <div id="input-wrapper" className="flex items-baseline">
                                                                                                    <div className="flex-1 flex items-center">
                                                                                                        ...
                                                                                                        <div id="input-inner-wrapper" className="relative flex-1">
                                                                                                            <input name="max_capacity" step={1} min={1} inputMode="numeric" placeholder="50" className="text-[1rem] h-[calc(2.25rem+2*1px)] p-[0.625rem_0.875rem] transition-all duration-300 ease-in-out text-[rgb(19,21,23)] leading-[1] rounded-[0.5rem] overflow-hidden border border-solid border-[#ebeced] bg-[#fff] w-full m-0"></input>
                                                                                        ...
                                                                                        <div id="spread" className="gap-[.5rem] flex justify-between items-center">
                                                                                            <Label className="font-medium text-[rgba(19,21,23,0.64)] flex-1">Over-Capacity Waitlist</Label>
                                                                                            <Label id="lux-toggle" className="w-[2.375rem] h-6 flex-shrink-0 relative inline-block mb-0">
                                                                                                <Switch className="transition-all duration-300 ease-in-out absolute cursor-pointer top-0 left-0 bottom-0 right-0" />
                                                                                            </Label>
                                                                                        </div>
                                                                                        <div id="spread" className="gap-[.5rem] flex justify-between items-center">
                                                                                            <Button variant="nothing" type="submit" className="text-[#fff] bg-[#333537] border-[#333537] border border-solid w-full cursor-pointer transition-[all_0.3s_cubic-bezier(0.4,0,0.2,1) font-medium rounded-[0.5rem] relative whitespace-nowrap justify-center outline-offset-[.125rem] outline-2 outline outline-transparent max-w-full text-base p-[0.625rem_0.875rem] h-[calc(2.25rem+2*1px)] flex items-center m-0 leading-[1.5]">
                                                                ...
                                                                <div id="option-button" className="w-full p-[0.5rem_0.75rem] transition-all duration-300 ease-in-out relative overflow-hidden bg-[rgba(19,21,23,0.04)]">
                                                                    ...
                                                                    <div id="lux-menu-trigger" className="cursor-pointer min-w-0 gap-[.5rem] flex-1 items-center">
                                                                        <div id="" className="gap-[.5rem] flex items-center">
                                                                            ...
                                                                            <div id="label" className="select-none flex-1 text-[rgba(19,21,23,0.64)]">Visibility</div>
                                                                            <div className="gap-[.25rem] flex items-center">
                                                                                <div id="value" className="font-medium text-[rgba(19,21,23,0.64)]">Public</div>
                                                                                <div id="accessory" className="transition-all duration-300 ease-in-out text-[rgba(19,21,23,0.2)] hover:text-gray-800">
                                                                ...
                                                                <div id="rows" className="p-[.25rem_0.25rem]">
                                                                    <div role="button" className="w-full box-border gap-[0.75rem] max-w-[260px] transition-all duration-300 ease-in-out p-[.375rem_.5rem] rounded-[0.25rem] relative z-[1] flex items-center m-0 bg-transparent border border-solid border-transparent leading-[1.5]">
                                                                        ...
                                                                        <div id="text">
                                                                            ...
                                                                            <div className="text-[0.8125rem] text-[rgba(19,21,23,0.64)] float-left">Shown on your calendar and eligible to be featured.</div>
                                                                        </div>
                                                                    </div>
                                                                    <div role="button" className="w-full box-border gap-[0.75rem] max-w-[260px] transition-all duration-300 ease-in-out p-[.375rem_.5rem] rounded-[0.25rem] relative z-[1] flex items-center m-0 bg-transparent border border-solid border-transparent leading-[1.5]">
                                                                        <div id="icon" className="text-[rgba(19,21,23,0.64)] flex-shrink-0">
                                                                            <Sparkles className="block w-4 h-4 align-middle" />
                                                                        </div>
                                                                        <div id="text">
                                                                            <div className="font-medium">Private</div>
                                                                            <div className="text-[0.8125rem] text-[rgba(19,21,23,0.64)] float-left">Unlisted. Only people with the link can register.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </PopoverContent>
