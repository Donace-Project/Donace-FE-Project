                                                            ...
                                                            <div id="time-picker" className="bg-[rgba(19,21,23,0.04)] rounded-[0.5rem] overflow-hidden flex-1">
                                                                ...
                                                                <Dialog>
                                                                    <DialogTrigger asChild>
                                                                        <Button variant="secondary" type="button" className="justify-start text-black rounded-t-none border-t-none border-solid border-t-[rgba(19,21,23,0.08)] p-[0.375rem_0.75rem] w-full cursor-pointer transition-all duration-300 ease-in-out text-[0.8125rem] gap-[.5rem] flex items-center m-0 bg-transparent border leading-[1.5]">
                                                                            <div id="icon">
