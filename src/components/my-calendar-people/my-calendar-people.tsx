            ...
            <div id="zm-container" className="pl-[1rem!important] pr-[1rem!important] max-w-[820px] m-[0_auto]">
                <div id="can-divide with-divider medium">
                    <div id="section-title-wrapper medium">
                        ...
                        <div id="section-subtitle" className="mt-[-.875rem] mb-6 text-[#737577] text-[1rem]">Manage your subscribers and event attendees.</div>
                    </div>
                    <div id="search-bar" className="box-border">
                        <div id="spread" className="border border-solid border-[#333537] rounded-[0.5rem] relative overflow-hidden flex justify-between items-center">
                            <Input placeholder="Search" className="border-0 rounded-none pl-10 pt-2 pb-2 text-[1.125rem] bg-[#fff] flex-1 m-0" />
                            <div id="search-icon" className="absolute left-3 text-[rgba(19,21,23,0.32)] h-full pointer-events-none flex items-center">
                                <Search className="w-5 h-5 block align-middle" />
                            </div>
                            <div id="buttons" className="absolute right-0 bg-[#fff] flex items-center">
                    ...
                    <div id="simple-table-wrapper" className="border border-solid border-[rgba(19,21,23,0.08)] rounded-[0.5rem] overflow-hidden bg-[rgba(255,255,255,0.8)]">
                        <div id="base-row" className="border-b-0 border-t-0 p-[0.75rem_1rem] cursor-pointer">
                            <div id="simple-user-row" className="gap-3 flex justify-between items-center">
                                ...
                                <div id="info" className="overflow-hidden text-ellipsis whitespace-nowrap text-[#b3b5b7] min-w-0 flex-1">
                                    <div id="name" className="inline">
                                        <div className="inline font-medium overflow-hidden text-ellipsis whitespace-nowrap mr-[.5rem!important] min-w-0 text-[rgb(19,21,23)]">Donace</div>
                                    </div>
                                    <div id="email" className="inline overflow-hidden text-ellipsis whitespace-nowrap text-[#b3b5b7] min-w-0">donace@gmail.com</div>
                                </div>
                                <span className="whitespace-nowrap text-[0.875rem] text-[#b3b5b7]">Sep 5</span>
                            </div>
                        </div>
                    </div>
